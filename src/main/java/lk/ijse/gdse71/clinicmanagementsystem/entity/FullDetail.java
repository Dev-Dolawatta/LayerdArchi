...
public class FullDetail {
    ...
    public FullDetail(String PId, String CId, String date, String managePlan, String medication, String symptoms, String diagnosis, String testId, String testDesc, String testDate) {
        this.PId = PId;
        this.CId = CId;
        Date = date;
