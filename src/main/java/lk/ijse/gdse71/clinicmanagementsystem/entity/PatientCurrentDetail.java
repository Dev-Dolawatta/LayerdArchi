...
public class PatientCurrentDetail {
    ...
    public PatientCurrentDetail() {

    }

    public PatientCurrentDetail(String patientId, String bloodPressure, String heartRate, String status,String clinicToBeAssigned) {
