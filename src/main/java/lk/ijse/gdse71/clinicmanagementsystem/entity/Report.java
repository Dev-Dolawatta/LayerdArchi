...
public class Report {
    ...
    public Report(String name, String clinicId, String managePlan, String medication, String symptoms, String diagnosis, String testId, String description, String date) {
        this.name = name;
