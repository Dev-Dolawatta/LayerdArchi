...
public class OrthoListViewController {

    public AnchorPane orthoListPane;
...
//        PatientDAO patientDAO = new PatientDAOImpl();
        ObservableList<PatientListDTO> patientListDTOS = patientBO.getOrthoList();
