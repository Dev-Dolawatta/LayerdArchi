...
public class PreoperListViewController {
    ...
    @FXML
    private AnchorPane preOperListPane;
...
//        PatientDAO patientDAO = new PatientDAOImpl();
        ObservableList<PatientListDTO> patientListDTOS = patientBO.getPreoperList();
