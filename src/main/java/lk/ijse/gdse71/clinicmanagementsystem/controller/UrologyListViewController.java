...
public class UrologyListViewController {

    @FXML
    private AnchorPane uroListPane;
...
//        PatientDAO patientDAO = new PatientDAOImpl();
        ObservableList<PatientListDTO> patientListDTOS = patientBO.getUroList();
