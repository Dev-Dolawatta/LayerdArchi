...
public class GynListController {


    public AnchorPane gynListPane;
...
//        PatientDAO patientDAO = new PatientDAOImpl();
        ObservableList<PatientListDTO> patientListDTOS = patientBO.getGynList();
