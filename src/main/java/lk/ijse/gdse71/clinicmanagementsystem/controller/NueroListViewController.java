...
public class NueroListViewController {
    ...
    @FXML
    private AnchorPane nueroListPane;
...
//        PatientDAO patientDAO = new PatientDAOImpl();
        ObservableList<PatientListDTO> patientListDTOS = patientBO.getNueroList();
