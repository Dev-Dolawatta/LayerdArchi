...
public class SurgicalListController {
    ...
    public AnchorPane surgicalListPane;
...
//        PatientDAOImpl patientDAO = new PatientDAOImpl();
        ObservableList<PatientListDTO> patientListDTOS = patientBO.getSurgicalList();
