...
public class MedicalClViewController {
    @FXML
    ...
    void backOnClick(ActionEvent event) throws IOException {
        medicalPane.getChildren().clear();
        AnchorPane pane = FXMLLoader.load(getClass().getResource("/view/ClinicDocView.fxml"));
        medicalPane.getChildren().add(pane);
    }

    @FXML
    void searchPatientDetail(ActionEvent event) throws SQLException {
...
//        ClinicDAO clinicDAO = new ClinicDAOImpl();
        if (txtPatientId.getText().isEmpty()) {
            ...
            PatientDetailsDTO patientDetailsDTOS = clinicBO.searchPatientDetails(Nic);
            String Name = patientDetailsDTOS.getName();
            String BGroup = patientDetailsDTOS.getBloodGroup();
            lblName.setText(Name);
            lblBloodG.setText(BGroup);
    ...
    @FXML
    void saveOnClick(ActionEvent event) throws SQLException {
...
//                ClinicDAO clinicDAO = new ClinicDAOImpl();
    ...
    void showListOnClick(ActionEvent event) throws IOException {
        medicalPane.getChildren().clear();
        AnchorPane pane = FXMLLoader.load(getClass().getResource("/view/PatientListView.fxml"));
        medicalPane.getChildren().add(pane);
