...
public class NewPreOperativeClViewController {
    @FXML
    ...
    @FXML
    private AnchorPane preOperPane;
...
//    ClinicDAO clinicDAO = new ClinicDAOImpl();
    ...
    void backOnClick(ActionEvent event) throws IOException {
        preOperPane.getChildren().clear();
        AnchorPane pane = FXMLLoader.load(getClass().getResource("/view/ClinicDocView.fxml"));
        preOperPane.getChildren().add(pane);
    }

    @FXML
    void preOperPSearch(ActionEvent event) throws SQLException {
...
//        ReportDAO reportDAO = new ReportDAOImpl();
    ...
    void showList(ActionEvent event) throws IOException {
        preOperPane.getChildren().clear();
        AnchorPane pane = FXMLLoader.load(getClass().getResource("/view/PreoperListView.fxml"));
        preOperPane.getChildren().add(pane);
    }
