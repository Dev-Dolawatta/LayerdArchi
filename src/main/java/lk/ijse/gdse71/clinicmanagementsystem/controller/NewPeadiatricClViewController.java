...
public class NewPeadiatricClViewController {
...
//    ClinicDAO clinicDAO = new ClinicDAOImpl();
    ...
    @FXML
    void peadiaPSearch(ActionEvent event) throws SQLException {
//        ClinicModel clinicModel = new ClinicModel();
        if (txtPId.getText().isEmpty()) {
            Alert alert = new Alert(Alert.AlertType.WARNING);
            alert.setTitle("Warning");
            alert.setHeaderText("Fill out Patient Id first!");
            alert.showAndWait();
...
//        ReportDAO reportDAO = new ReportDAOImpl();
    ...
    void showList(ActionEvent event) throws IOException {
        peadiaPane.getChildren().clear();
        AnchorPane pane = FXMLLoader.load(getClass().getResource("/view/PeadiacList View.fxml"));
        peadiaPane.getChildren().add(pane);
    }
